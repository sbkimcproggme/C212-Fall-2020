...
public class MondrianScalable{
    int x, y;
    double scale;
    public MondrianScalable(int x, int y, double scale) {
        this.x = x;
        this.y = y;
        this.scale = scale;
    }
    ...
    public void paint(Graphics g) {
        ...
        int xind30 = 450, xind31 = 350, yind31 = 380;
        for (int xforloop=0; xforloop<100; xforloop++){
            g.drawLine(x+scale(450),y+scale(500), x+scale(xind31),y+scale(yind31));
            xind30++;
            xind31++;
            yind31++;
        }
        g.setColor(new Color(0, 195, 237));
        int yind40 = 350, xind41 = 450, yind41 = 300;
        for (int xforloop=0; xforloop<50; xforloop++){
            g.drawLine(x+scale(500),y+scale(yind40), x+scale(xind41),y+scale(yind41));
            yind40++;
            xind41++;
            yind41++;
        }
